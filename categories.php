...
$clients=include("./DATABASE/show_categories.php");
?>
<!DOCTYPE html>
<html>
<head>
	<title>Virgin's Categories</title>
	<meta charset="utf-8">
...
<body>
    ...
    <form style="width: 100%;" method="post" action="./DATABASE/addcategory.php">
    	<div class="mb-3 mt-3">
   	<label class="form-label" for="name">Désignation</label>
   	<input class="form-control" type="text" name="name" placeholder="Enter the category's name" required>
  		</div>
  	...
  	<button type="submit" class="btn btn-dark" name="add"><i class="fas fa-plus"></i> Ajouter</button>
  			...
  			<div class="col-9">
            <h5 class="card-title" style="text-align: center;padding: 20px;">Nos Catégories de Produits</h5>    	
  ...
  <tbody>
      ...
      ?>
   <tr>
      <td><a href="./DATABASE/deletecategory.php?delete=<?php echo $row[0]?>"><i class="fas fa-user-slash"></i></a>
      <a href="./DATABASE/updatecategory.php?edit=<?php echo $row[0]?>"><i class="fas fa-user-edit"></i></a></td>
