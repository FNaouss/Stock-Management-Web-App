...
$clients=include("./DATABASE/show_fournisseurs.php");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <form style="width: 100%;" method="post" action="./DATABASE/addfournisseur.php">
    	<div class="mb-3 mt-3">
    ...
    <label for="adresse" class="form-label">Adresse</label>
   	<input type="text" class="form-control" id="adresse" placeholder="Enter address" name="adresse" required>
  		</div>
  		<div class="mb-3">
    <label for="numéro" class="form-label">Numéro de téléphone</label>
  	...
  	<button type="submit" class="btn btn-dark"><i class="fas fa-plus"></i> Ajouter</button>
  			...
  			<div class="col-9">
            <h5 class="card-title" style="text-align: center;padding: 20px;">Nos Fournisseurs</h5>    	
  ...
  <tbody>
      ...
      ?>
   <tr>
      <td><a href="./DATABASE/deletefournisseur.php?delete=<?php echo $row['0']?>"><i class="fas fa-user-slash"></i></a>
      <a href="./DATABASE/updatefournisseur.php?edit=<?php echo $row['0']?>"><i class="fas fa-user-edit"></i></a></td>
